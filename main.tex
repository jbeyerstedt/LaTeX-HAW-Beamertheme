...
\begin{frame}[fragile]{Version Info}
  ...
  I don't know, why, but in beamer.r43073 and older (which are installed at Overleaf) the footer section behaves differently than in the newer versions of beamer.
  Currently the old version will produce the correct output.
\end{frame}
